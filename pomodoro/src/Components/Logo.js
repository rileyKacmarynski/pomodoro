...
function Logo() {  
  ...
  return (
    <Container>
      <h2 className={states.pomodoro === state ? "show" : undefined}>pomodoro</h2>
      <h2 className={states.shortBreak === state ? "show" : undefined}>short break</h2>
      <h2 className={states.longBreak === state ? "show" : undefined}>long break</h2>
    </Container>
  )
}
